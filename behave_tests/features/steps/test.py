...
def multiple_sessions(context):
    ...
    context.driver1.get("http://localhost:4568i/")
    context.driver2.get("http://localhost:4568/")
    context.driver3.get("http://localhost:4568/")
    context.driver4.get("http://localhost:4568/")
    context.driver5.get("http://localhost:4568/")
    context.driver6.get("http://localhost:4568/")
    context.driver7.get("http://localhost:4568/")
    context.driver8.get("http://localhost:4568/")
    context.driver9.get("http://localhost:4568/")
